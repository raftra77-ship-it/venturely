...
export const INITIAL_PRODUCTS: Product[] = [
  {
    ...
    adMetrics: {
      ...
      roas: 4.8,
      metaCampaign: {
        id: 'meta_cmp_zenring_9921',
        productId: 'prod_1',
        adPlatform: 'meta',
        budget: 14999,
        dailyBudget: 2142,
        status: 'ACTIVE',
        targetAudience: 'Biohackers (24-40), Tech Professionals, Mindfulness Seekers in Bengaluru, Mumbai, Delhi',
        creativeHeadline: 'Liquid Titanium Mood Ring: 60-Second Real-Time Stress Biofeedback',
        creativeImageUrl: 'https://images.unsplash.com/photo-1605100804763-247f67b3557e?auto=format&fit=crop&w=1000&q=80',
        pixelId: 'pix_meta_7849120',
        impressions: 184000,
        reach: 149000,
        clicks: 7360,
        ctr: 4.0,
